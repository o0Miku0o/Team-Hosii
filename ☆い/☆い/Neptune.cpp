...
namespace Neptune
{
	...
	void Obj::Update()
	{
		...
		cNeptuneHitBase.SetPos(&rNeptune.GetPos());
		cNeptuneHitBase.SetRadius(rNeptune.GetW()*0.4f);
		cGravityCircle.SetPos(&rNeptune.GetPos());
		cGravityCircle.SetRadius(rNeptune.GetW()*0.8f);
	}
	/*タスクの描画処理*/
	void Obj::Render()
	{
